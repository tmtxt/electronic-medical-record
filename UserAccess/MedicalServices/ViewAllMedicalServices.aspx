        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="AllMedicalServicesGridView" runat="server"
                    DataKeyNames="ID" AutoGenerateColumns="false" AutoGenerateDeleteButton="false"
                    AutoGenerateEditButton="false"
                    CssClass="gridview table table-bordered table-striped table-hover"
                    OnRowDeleted="AllMedicalServicesGridView_RowDeleted" OnRowDeleting="AllMedicalServicesGridView_RowDeleting">
