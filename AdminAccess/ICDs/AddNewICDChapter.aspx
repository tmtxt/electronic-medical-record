    ...
    <form runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:LinqDataSource ID="AddNewICDChapterDataSource" runat="server" ContextTypeName="DataClassesDataContext" EnableInsert="True" EntityTypeName="" TableName="ICDChapters" OnInserted="AddNewICDChapterDataSource_Inserted">
                </asp:LinqDataSource>
                <p></p>
